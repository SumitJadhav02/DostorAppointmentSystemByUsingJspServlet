...
<head>
    ...
    <title>Product Doctor - Dashboard HTML Template</title>
        ...
        <nav class="navbar navbar-expand-xl">
            <div class="container h-100">
                <a class="navbar-brand" href="index.html">
                    <h1 class="tm-site-title mb-0">All Apointment List</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   ...
                   <!--   <ul class="navbar-nav">
                     ...
                     <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link d-block" href="user.jsp">
                            <b>Back</b>
                            </a>
                        </li>
                    </ul>
        ...
        <footer class="tm-footer row tm-mt-small">
            <div class="col-12 font-weight-light">
                <p class="text-center text-white mb-0 px-4 small">
                    ...
                    Design: <a rel="nofollow noopener" class="tm-footer-link">Sumit Jadhav</a>
                </p>
            </div>
        </footer>
    </div>
